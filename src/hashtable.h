...
static int deallocate_all_entries(bucket_t** entries, int size); // corrected
static int deallocate_buckets(bucket_t* buckets); // corrected
static bool check_key(hashtable_t* hashtable, char* key); // corrected
